        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginDistrict = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DestCity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestDistrict = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adverts_Users_SenderId",
                        column: x => x.SenderId,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AverageRating", "City", "CreatedAt", "Email", "FirstName", "IsActive", "LastName", "PasswordHash", "Phone", "RatingCount", "Role", "VehicleType" },
                values: new object[] { 1, 0m, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@nakliye.com", "Admin", true, "User", "$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewKnrWNtELbHSvQy", null, 0, "Admin", null });

            migrationBuilder.CreateIndex(
                name: "IX_Adverts_SenderId",
                table: "Adverts",
                column: "SenderId");
